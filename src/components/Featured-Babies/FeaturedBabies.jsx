...
import "../Featured-Babies/FeaturedBabies.css";
...
function FeaturedBabies() {
  return (
    <>
      ...
      <span> Featured Babies and Kids Photographers</span>
        <div className='media-scroller-babies w-75 mx-auto'>
          <div className="medial-element-babies">
          <div className='card'>
