...
import "../Featured-Food/FeaturedFood.css";
...
function FeaturedFood() {
  return (
    <>
      <div className="featured-food-container mt-5 bg-light">
      <span> Featured Food Photographers</span>
        <div className='media-scroller-food w-75 mx-auto'>
          <div className="medial-element-food">
          <div className='card'>
